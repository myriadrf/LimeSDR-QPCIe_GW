...
# setting SOPC_SYSID_BASE_ADDRESS is 0x6e0
SOPC_SYSID_FLAG += --sidp=0x6e0
ELF_PATCH_FLAG  += --sidp 0x6e0

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1518428261
SOPC_SYSID_FLAG += --timestamp=1518428261
ELF_PATCH_FLAG  += --timestamp 1518428261
