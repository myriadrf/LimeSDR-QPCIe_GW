...
-- ----------------------------------------------------------------------------
   ...
   LMS2_RESET       	<= inst0_from_fpgacfg_0.LMS2_RESET;
   LMS2_TXEN        	<= inst0_from_fpgacfg_0.LMS2_TXEN;
   LMS2_RXEN        	<= inst0_from_fpgacfg_0.LMS2_RXEN;
   LMS2_CORE_LDO_EN 	<= inst0_from_fpgacfg_0.LMS2_CORE_LDO_EN;
   LMS2_TXNRX1      	<= inst0_from_fpgacfg_0.LMS2_TXNRX1;
   LMS2_TXNRX2      	<= inst0_from_fpgacfg_0.LMS2_TXNRX2;
