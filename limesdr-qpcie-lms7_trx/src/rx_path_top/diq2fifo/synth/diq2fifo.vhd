...
signal inst3_cmp_AI     : std_logic_vector(15 downto 0);
signal inst3_cmp_AQ     : std_logic_vector(15 downto 0);
signal inst3_cmp_BI     : std_logic_vector(15 downto 0);
signal inst3_cmp_BQ     : std_logic_vector(15 downto 0);
...
inst3_smpl_cmp : entity work.smpl_cmp
   ...
   port map(
      ...
      cmp_AI      => inst3_cmp_AI(iq_width-1 downto 0),
      cmp_AQ      => inst3_cmp_AQ(iq_width-1 downto 0),
      cmp_BI      => inst3_cmp_BI(iq_width-1 downto 0),
      cmp_BQ      => inst3_cmp_BQ(iq_width-1 downto 0),
