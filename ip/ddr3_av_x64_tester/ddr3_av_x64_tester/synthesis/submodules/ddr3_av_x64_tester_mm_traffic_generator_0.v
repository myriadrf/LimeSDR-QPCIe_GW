// ddr3_av_x64_tester_mm_traffic_generator_0.v
...
`timescale 1 ps / 1 ps
module ddr3_av_x64_tester_mm_traffic_generator_0 #(
		parameter DEVICE_FAMILY                          = "Cyclone V",
		parameter TG_AVL_DATA_WIDTH                      = 64,
		parameter TG_AVL_ADDR_WIDTH                      = 26,
		...
		output wire [63:0] pnf_per_bit,         //       pnf.pnf_per_bit
		output wire [63:0] pnf_per_bit_persist, //          .pnf_per_bit_persist
		input  wire        avl_ready,           //       avl.waitrequest_n
		output wire [25:0] avl_addr,            //          .address
